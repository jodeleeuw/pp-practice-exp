...
jsPsych.pluginAPI = (function() {
  ...
  module.autoPreload = function(timeline, callback, images, audio, video, progress_bar) {
    ...
    if(progress_bar){
      var pb_html = "<p style='width:700px;'>The experiment is loading. This may take a few minutes on slower connections.</p>"
      pb_html += "<div id='jspsych-loading-progress-bar-container' style='height: 10px; width: 700px; background-color: #ddd;'>";
